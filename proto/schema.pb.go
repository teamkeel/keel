// CONCERNS
// replace operation inputs with messages
// no such thing as outputs -> we'll ened response message
// retain operation inputs compatibility until we've migrated entirely to using messages (all within scope of project)
// should we use compoision/inheritance to model input and response fields
// model fields and message types are not the same
// InputMessage+InputMessageField and OutputMessage+OutputMessageField types are more specialised (inputs have optional, InputType, InputBehaviour, target)
...
const (
	...
	OperationType_OPERATION_TYPE_AUTHENTICATE OperationType = 6
)
...
type Field struct {
	...
	// The name of the model this field belongs to (if part of a model)
...
type Operation struct {
	...
	// The name of the response message type for this operation when not a built-in action.
...
type MessageField struct {
	...
	// Name of the field. Must be lowerCamelCase and unique within the parent message.
	Name string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	// The type of this field.
	Type *TypeInfo `protobuf:"bytes,3,opt,name=type,proto3" json:"type,omitempty"`
	// Set to true if this field is optional
	Optional bool `protobuf:"varint,4,opt,name=optional,proto3" json:"optional,omitempty"`
	// Only valid for implicit inputs on built-in actions
...
var file_proto_schema_proto_rawDesc = []byte{
	...
	0x45, 0x5f, 0x42, 0x4f, 0x4f, 0x4c, 0x10, 0x03, 0x2a, 0x87, 0x01, 0x0a, 0x17, 0x4f, 0x70, 0x65,
	...
	0x10, 0x02, 0x2a, 0xce, 0x01, 0x0a, 0x0d, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x50, 0x45, 0x5f, 0x43, 0x52, 0x45, 0x41, 0x54, 0x45, 0x10, 0x01, 0x12, 0x16, 0x0a, 0x12, 0x4f,
	0x50, 0x45, 0x52, 0x41, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x47, 0x45,
	0x54, 0x10, 0x02, 0x12, 0x17, 0x0a, 0x13, 0x4f, 0x50, 0x45, 0x52, 0x41, 0x54, 0x49, 0x4f, 0x4e,
	0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x4c, 0x49, 0x53, 0x54, 0x10, 0x03, 0x12, 0x19, 0x0a, 0x15,
	0x4f, 0x50, 0x45, 0x52, 0x41, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x55,
	0x50, 0x44, 0x41, 0x54, 0x45, 0x10, 0x04, 0x12, 0x19, 0x0a, 0x15, 0x4f, 0x50, 0x45, 0x52, 0x41,
	...
	0x54, 0x59, 0x50, 0x45, 0x5f, 0x41, 0x55, 0x54, 0x48, 0x45, 0x4e, 0x54, 0x49, 0x43, 0x41, 0x54,
	0x45, 0x10, 0x06, 0x2a, 0x92, 0x02, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65, 0x12, 0x10, 0x0a, 0x0c,
	...
	0x45, 0x53, 0x53, 0x41, 0x47, 0x45, 0x10, 0x10, 0x42, 0x1b, 0x5a, 0x19, 0x67, 0x69, 0x74, 0x68,
