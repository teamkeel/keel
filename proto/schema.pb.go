...
var file_proto_schema_proto_rawDesc = []byte{
	...
	0x70, 0x70, 0x65, 0x72, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xfe, 0x03, 0x0a, 0x06,
	...
	0x2e, 0x46, 0x6c, 0x6f, 0x77, 0x52, 0x05, 0x66, 0x6c, 0x6f, 0x77, 0x73, 0x22, 0xa3, 0x01, 0x0a,
	...
	0x65, 0x6c, 0x64, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x2e, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x52, 0x06, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x73,
	0x12, 0x27, 0x0a, 0x07, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x0d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x52, 0x07, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x37, 0x0a, 0x0b, 0x70, 0x65, 0x72,
	...
	0x6e, 0x73, 0x22, 0xe0, 0x04, 0x0a, 0x05, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x12, 0x1d, 0x0a, 0x0a,
	0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x09, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x6e,
...
var file_proto_schema_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
var file_proto_schema_proto_goTypes = []any{
	...
	(*Sequence)(nil),               // 8: proto.Sequence
	(*ForeignKeyInfo)(nil),         // 9: proto.ForeignKeyInfo
	(*DefaultValue)(nil),           // 10: proto.DefaultValue
	(*Action)(nil),                 // 11: proto.Action
	(*Role)(nil),                   // 12: proto.Role
	(*PermissionRule)(nil),         // 13: proto.PermissionRule
	(*OrderByStatement)(nil),       // 14: proto.OrderByStatement
	(*Expression)(nil),             // 15: proto.Expression
	(*Api)(nil),                    // 16: proto.Api
	(*ApiModel)(nil),               // 17: proto.ApiModel
	(*ApiModelAction)(nil),         // 18: proto.ApiModelAction
	(*Enum)(nil),                   // 19: proto.Enum
	(*EnumValue)(nil),              // 20: proto.EnumValue
	(*Message)(nil),                // 21: proto.Message
	(*MessageField)(nil),           // 22: proto.MessageField
	(*TypeInfo)(nil),               // 23: proto.TypeInfo
	(*EnvironmentVariable)(nil),    // 24: proto.EnvironmentVariable
	(*Secret)(nil),                 // 25: proto.Secret
	(*Job)(nil),                    // 26: proto.Job
	(*Schedule)(nil),               // 27: proto.Schedule
	(*Subscriber)(nil),             // 28: proto.Subscriber
	(*Event)(nil),                  // 29: proto.Event
	(*Route)(nil),                  // 30: proto.Route
	(*Flow)(nil),                   // 31: proto.Flow
...
var file_proto_schema_proto_depIdxs = []int32{
	...
	16, // 2: proto.Schema.apis:type_name -> proto.Api
	19, // 3: proto.Schema.enums:type_name -> proto.Enum
	24, // 4: proto.Schema.environment_variables:type_name -> proto.EnvironmentVariable
	21, // 5: proto.Schema.messages:type_name -> proto.Message
	25, // 6: proto.Schema.secrets:type_name -> proto.Secret
	26, // 7: proto.Schema.jobs:type_name -> proto.Job
	28, // 8: proto.Schema.subscribers:type_name -> proto.Subscriber
	29, // 9: proto.Schema.events:type_name -> proto.Event
	30, // 10: proto.Schema.routes:type_name -> proto.Route
	31, // 11: proto.Schema.flows:type_name -> proto.Flow
	7,  // 12: proto.Model.fields:type_name -> proto.Field
	11, // 13: proto.Model.actions:type_name -> proto.Action
	13, // 14: proto.Model.permissions:type_name -> proto.PermissionRule
	23, // 15: proto.Field.type:type_name -> proto.TypeInfo
	32, // 16: proto.Field.foreign_key_field_name:type_name -> google.protobuf.StringValue
	10, // 17: proto.Field.default_value:type_name -> proto.DefaultValue
	9,  // 18: proto.Field.foreign_key_info:type_name -> proto.ForeignKeyInfo
	32, // 19: proto.Field.inverse_field_name:type_name -> google.protobuf.StringValue
	15, // 20: proto.Field.computed_expression:type_name -> proto.Expression
	8,  // 21: proto.Field.sequence:type_name -> proto.Sequence
	15, // 22: proto.DefaultValue.expression:type_name -> proto.Expression
	1,  // 23: proto.Action.type:type_name -> proto.ActionType
	0,  // 24: proto.Action.implementation:type_name -> proto.ActionImplementation
	13, // 25: proto.Action.permissions:type_name -> proto.PermissionRule
	15, // 26: proto.Action.set_expressions:type_name -> proto.Expression
	15, // 27: proto.Action.where_expressions:type_name -> proto.Expression
	15, // 28: proto.Action.validation_expressions:type_name -> proto.Expression
	14, // 29: proto.Action.order_by:type_name -> proto.OrderByStatement
	32, // 30: proto.PermissionRule.action_name:type_name -> google.protobuf.StringValue
	15, // 31: proto.PermissionRule.expression:type_name -> proto.Expression
	1,  // 32: proto.PermissionRule.action_types:type_name -> proto.ActionType
	3,  // 33: proto.OrderByStatement.direction:type_name -> proto.OrderDirection
	17, // 34: proto.Api.api_models:type_name -> proto.ApiModel
	18, // 35: proto.ApiModel.model_actions:type_name -> proto.ApiModelAction
	20, // 36: proto.Enum.values:type_name -> proto.EnumValue
	22, // 37: proto.Message.fields:type_name -> proto.MessageField
	23, // 38: proto.Message.type:type_name -> proto.TypeInfo
	23, // 39: proto.MessageField.type:type_name -> proto.TypeInfo
	2,  // 40: proto.TypeInfo.type:type_name -> proto.Type
	32, // 41: proto.TypeInfo.enum_name:type_name -> google.protobuf.StringValue
	32, // 42: proto.TypeInfo.model_name:type_name -> google.protobuf.StringValue
	32, // 43: proto.TypeInfo.field_name:type_name -> google.protobuf.StringValue
	32, // 44: proto.TypeInfo.message_name:type_name -> google.protobuf.StringValue
	32, // 45: proto.TypeInfo.union_names:type_name -> google.protobuf.StringValue
	32, // 46: proto.TypeInfo.string_literal_value:type_name -> google.protobuf.StringValue
	13, // 47: proto.Job.permissions:type_name -> proto.PermissionRule
	27, // 48: proto.Job.schedule:type_name -> proto.Schedule
	1,  // 49: proto.Event.action_type:type_name -> proto.ActionType
	4,  // 50: proto.Route.method:type_name -> proto.HttpMethod
	13, // 51: proto.Flow.permissions:type_name -> proto.PermissionRule
	27, // 52: proto.Flow.schedule:type_name -> proto.Schedule
