...
func TestAuditCreateAction(t *testing.T) {
	...
	wedding["created_at"] = wedding["created_at"].(time.Time).Local().Format("2006-01-02T15:04:05.999999999-07:00")
	wedding["updated_at"] = wedding["updated_at"].(time.Time).Local().Format("2006-01-02T15:04:05.999999999-07:00")
...
func TestAuditNestedCreateAction(t *testing.T) {
	...
	// This is due to https://linear.app/keel/issue/BLD-824/storing-dates-in-utc-and-not-with-timezone
	pete["created_at"] = pete["created_at"].(time.Time).Local().Format("2006-01-02T15:04:05.999999999-07:00")
	pete["updated_at"] = pete["updated_at"].(time.Time).Local().Format("2006-01-02T15:04:05.999999999-07:00")

	// This is due to https://linear.app/keel/issue/BLD-824/storing-dates-in-utc-and-not-with-timezone
	adam["created_at"] = adam["created_at"].(time.Time).Local().Format("2006-01-02T15:04:05.999999999-07:00")
	adam["updated_at"] = adam["updated_at"].(time.Time).Local().Format("2006-01-02T15:04:05.999999999-07:00")
