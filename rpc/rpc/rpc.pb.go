...
var file_rpc_rpc_proto_rawDesc = []byte{
	...
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x74, 0x0a, 0x03, 0x41, 0x50, 0x49, 0x12,
	...
	0x50, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x40, 0x0a, 0x0f,
	...
	0x5a, 0x07, 0x72, 0x70, 0x63, 0x2f, 0x72, 0x70, 0x63, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_rpc_rpc_proto_goTypes = []interface{}{
	(*GetSchemaRequest)(nil),  // 0: rpc.GetSchemaRequest
	(*GetSchemaResponse)(nil), // 1: rpc.GetSchemaResponse
	(*PingRequest)(nil),       // 2: rpc.PingRequest
	(*PingResponse)(nil),      // 3: rpc.PingResponse
	(*proto.Schema)(nil),      // 4: proto.Schema
}
var file_rpc_rpc_proto_depIdxs = []int32{
	4, // 0: rpc.GetSchemaResponse.schema:type_name -> proto.Schema
	2, // 1: rpc.API.Ping:input_type -> rpc.PingRequest
	0, // 2: rpc.API.GetActiveSchema:input_type -> rpc.GetSchemaRequest
	3, // 3: rpc.API.Ping:output_type -> rpc.PingResponse
	1, // 4: rpc.API.GetActiveSchema:output_type -> rpc.GetSchemaResponse
