...
WHERE
	n.nspname = 'public'
	AND c.relname not in ('keel_schema', 'keel_refresh_token', 'keel_storage', 'keel_auth_code', 'pg_stat_statements_info', 'pg_stat_statements','debug_log', 'debug_log', 'debug_log_id_seq')
	AND a.attnum > 0
