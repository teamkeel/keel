...
The Custom functions runtime is a small wrapper around the users custom functions. Many TypeScript + JavaScript files are code generated by our Keel CLI (Golang) based off of the contents of a `.keel schema`.
