...
func TestCompletions(t *testing.T) {
	...
	cases := []testCase{
		...
		},
		{
			...
			expected: []string{"Foo", "Identity", "ID", "Text", "Number", "Boolean", "Date", "Timestamp", "Secret"},
		},
		{
		...
		},
		{
			...
			expected: []string{"Author", "Book", "Identity", "ID", "Text", "Number", "Boolean", "Date", "Timestamp", "Secret"},
		},
		{
			...
			expected: []string{"Book", "Category", "Identity", "ID", "Text", "Number", "Boolean", "Date", "Timestamp", "Secret"},
		},
		{
		...
		},
		{
			...
			`,
			expected: []string{
				"Boolean", "Date", "ID", "Identity", "Number", "Text", "Timestamp", "Secret", "createdAt", "id", "name", "updatedAt",
			},
		},
		{
