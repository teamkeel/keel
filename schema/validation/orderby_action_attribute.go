...
func OrderByActionAttributeRule(asts []*parser.AST, errs *errorhandling.ValidationErrors) Visitor {
	...
	return Visitor{
		...
		EnterAttribute: func(attribute *parser.AttributeNode) {
			...
			if currentAction.Type.Value != parser.ActionTypeList {
		...
		LeaveAttribute: func(_ *parser.AttributeNode) {
