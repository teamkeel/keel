...
export class APIClient extends Core {
    ...
    private actions = {
        createAccount: (i: CreateAccountInput) => {
            return this.client.rawRequest<Account>("createAccount", i);
        },
        getAccount: (i: GetAccountInput) => {
            return this.client.rawRequest<Account | null>("getAccount", i);
        },
        writeAccounts: (i: WriteAccountsInput) => {
            return this.client.rawRequest<FileResponse>("writeAccounts", i);
        },
    ...
    api = {
        queries: {
            getAccount: this.actions.getAccount,
        },
        mutations: {
            createAccount: this.actions.createAccount,
            writeAccounts: this.actions.writeAccounts,
...
export interface WriteAccountsInput {
    csv: string;
}
