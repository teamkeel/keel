...
test("ZZZ list operation where expressions with M:1 relations with RHS field operand - all models active - all models returned", async () => {
  ...
  const { results: posts } = await actions.listActivePostsWithRhsField2({});
