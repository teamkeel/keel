...
test('string permission on literal - all matching - is authorized', async () => {
  ...
  expect(
    await actions
      .listWithTextPermissionLiteral({ isActive: { equals: true } })
...
test('number permission on literal - all matching - is authorized', async () => {
  ...
  expect(
    await actions
      .listWithNumberPermissionLiteral({ isActive: { equals: true } })
  ).notToHaveAuthorizationError()
})
...
test('boolean permission on literal - all matching - is authorized', async () => {
  ...
  expect(
    await actions
      .listWithBooleanPermissionLiteral({ isActive: { equals: true } })
  ).notToHaveAuthorizationError()
})
...
test('enum permission on literal - all matching - is authorized', async () => {
  ...
  expect(
    await actions
      .listWithEnumPermissionLiteral({ isActive: { equals: true } })
  ).notToHaveAuthorizationError()
})
...
test('string permission on field - all matching - is authorized', async () => {
  ...
  expect(
    await actions
      .listWithTextPermissionFromField({ isActive: { equals: true } })
  ).notToHaveAuthorizationError()
})
...
test('number permission on field - all matching - is authorized', async () => {
  ...
  expect(
    await actions
      .listWithNumberPermissionFromField({ isActive: { equals: true } })
  ).notToHaveAuthorizationError()
})
...
test('boolean permission on field - all matching - is authorized', async () => {
  ...
  expect(
    await actions
      .listWithBooleanPermissionFromField({ isActive: { equals: true } })
  ).notToHaveAuthorizationError()
})
...
test('enum permission on field name - all matching - is authorized', async () => {
  ...
  expect(
    await actions
    .listWithEnumPermissionFromField({ isActive: { equals: true } })
  ).notToHaveAuthorizationError()
})
...
test('identity permission - correct identity in context - is authorized', async () => {
  ...
  await actions
    ...
    .createWithIdentity({ isActive: false})
...
test('permission on explicit input - all matching - is authorized', async () => {
  ...
  expect(
    await actions
      .listWithTextPermissionFromExplicitInput({ isActive: { equals: true }, explTitle: "hello" })
  ).notToHaveAuthorizationError()
})
